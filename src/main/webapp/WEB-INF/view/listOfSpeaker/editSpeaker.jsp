...
<body>
	...
	<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/editSpeaker.action" method="post">
		<div class="form-group">
			<label for="inputEmail3" class="col-md-3 control-label">名字</label>
			<div class="col-md-8">
				<input type="text" class="form-control"  name="speakerName"  value="${s.speakerName}"   placeholder="">
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-3 control-label">职业</label>
			<div class="col-md-8">
				<input type="text" class="form-control"  name="speakerJob"  value="${s.speakerJob}"  placeholder="">
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-3 control-label">头像图片</label>
			<div class="col-md-8">
				<input type="text" class="form-control"  name="speakerHeadUrl"  value="${s.speakerHeadUrl}"  placeholder=" ">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-8">
				<textarea class="p100" name="speakerDescr" placeholder="请填写简介"
					style="width: 1000px; height: 100px;">${s.speakerDescr}</textarea>
			</div>
